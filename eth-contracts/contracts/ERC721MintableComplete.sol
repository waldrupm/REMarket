...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "Must be owner to do that");
        _;
    }

    constructor () internal {
        _owner = msg.sender;
        emit OwnershipTransferred(0x0000000000000000000000000000000000000000, msg.sender);
    }
...
//    @dev Approves another address to transfer the given token ID
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(_exists(tokenId) != true && to != address(0), "That token exists or the to address is invalid");
